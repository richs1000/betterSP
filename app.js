...
var $author$project$ProgressBar$emptyProgressBar = function (masteryWindow) {
	return A2($elm$core$List$repeat, masteryWindow, $elm$core$Maybe$Nothing);
};
var $author$project$ScatterPlot$emptyScatterPlot = {data: _List_Nil, fOfX: _List_Nil, predictorVariable: 'no predictor variable', responseVariable: 'no response variable'};
var $author$project$ScatterPlotQuestion$emptyScatterPlotQuestion = {possibleResponses: _List_Nil, scatterPlot: $author$project$ScatterPlot$emptyScatterPlot, stem: 'This is an empty question'};
var $author$project$Main$createNewModel = F2(
	function (newWindowDimensions, newMasterySettings) {
		return {
			currentQuestion: $author$project$ScatterPlotQuestion$emptyScatterPlotQuestion,
			masterySettings: newMasterySettings,
			progressBar: $author$project$ProgressBar$emptyProgressBar(newMasterySettings.window),
			userResponse: $elm$core$Maybe$Nothing,
			windowDimensions: newWindowDimensions
		};
	});
var $author$project$MasterySettings$defaultMasterySettings = {threshold: 4, window: 6};
...
var $author$project$QuestionResponse$QuestionResponse = F3(
	function (correctAnswer, feedback, textPart) {
		return {correctAnswer: correctAnswer, feedback: feedback, textPart: textPart};
	});
var $author$project$ScatterPlotQuestion$ScatterPlotQuestion = F3(
	function (stem, scatterPlot, possibleResponses) {
		return {possibleResponses: possibleResponses, scatterPlot: scatterPlot, stem: stem};
	});
var $author$project$FunctionOfX$isQuadratic = function (fOfX) {
	return $elm$core$List$length(fOfX) < 3;
};
...
var $author$project$ScatterPlotQuestion$stringFromBool = function (value) {
	return value ? 'True' : 'False';
};
var $author$project$ScatterPlotQuestion$randomScatterPlotAnswers = F2(
	function (sPlot, qType) {
		var questionStem = function () {
			switch (qType.$) {
				case 'SPQWhatIsThePredictorVariable':
					return 'Given this scatter plot, what is the predictor variable?';
				case 'SPQWhatIsTheResponseVariable':
					return 'Given this scatter plot, what is the response variable?';
				default:
					return 'True or False: This scatter plot corresponds to a linear function';
			}
		}();
		var isQuadratic = $author$project$FunctionOfX$isQuadratic(sPlot.fOfX);
		var rightAnswer = function () {
			switch (qType.$) {
				case 'SPQWhatIsThePredictorVariable':
					return A3($author$project$QuestionResponse$QuestionResponse, true, 'Correct!', sPlot.predictorVariable);
				case 'SPQWhatIsTheResponseVariable':
					return A3($author$project$QuestionResponse$QuestionResponse, true, 'Correct!', sPlot.responseVariable);
				default:
					return A3(
						$author$project$QuestionResponse$QuestionResponse,
						true,
						'Correct!',
						$author$project$ScatterPlotQuestion$stringFromBool(isQuadratic));
			}
		}();
		var distractorOne = function () {
			switch (qType.$) {
				case 'SPQWhatIsThePredictorVariable':
					return A3($author$project$QuestionResponse$QuestionResponse, false, 'The predictor variable is on the x axis', sPlot.responseVariable);
				case 'SPQWhatIsTheResponseVariable':
					return A3($author$project$QuestionResponse$QuestionResponse, false, 'The predictor variable is on the x axis', sPlot.predictorVariable);
				default:
					return A3(
						$author$project$QuestionResponse$QuestionResponse,
						false,
		...
		var listOfDistractors = _List_fromArray(
			[rightAnswer, distractorOne]);
		return A2(
			$elm$random$Random$map,
			A2($author$project$ScatterPlotQuestion$ScatterPlotQuestion, questionStem, sPlot),
			$elm_community$random_extra$Random$List$shuffle(listOfDistractors));
	});
var $author$project$ScatterPlotQuestion$SPQLinearFunction = {$: 'SPQLinearFunction'};
var $author$project$ScatterPlotQuestion$SPQWhatIsThePredictorVariable = {$: 'SPQWhatIsThePredictorVariable'};
var $author$project$ScatterPlotQuestion$SPQWhatIsTheResponseVariable = {$: 'SPQWhatIsTheResponseVariable'};
...
var $author$project$ScatterPlotQuestion$randomScatterPlotQuestionType = A2(
	$elm$random$Random$uniform,
	$author$project$ScatterPlotQuestion$SPQWhatIsThePredictorVariable,
	_List_fromArray(
		[$author$project$ScatterPlotQuestion$SPQWhatIsTheResponseVariable, $author$project$ScatterPlotQuestion$SPQLinearFunction]));
...
var $author$project$ScatterPlot$firstPredictorVariable = 'Chest diameter (in inches)';
var $author$project$ScatterPlot$firstResponseVariable = 'Weight (in pounds)';
var $author$project$ScatterPlot$remainingPredictorVariables = _List_fromArray(
	['Functional Independence Measure (from 18 to 126)', 'Berg Balance Scale score (ranges from 0 to 56)', 'Grip strength (in pounds)', 'Age (in years)', 'Number of ADLs a client can complete independently', 'Number of falls an individual has in a month', 'Mini-Mental State Exam score (from 0 to 30)', 'Beck Depression Inventory score (from 0 to 63)']);
var $author$project$ScatterPlot$remainingResponseVariables = _List_fromArray(
	['Temperature (in degrees Celsius)', 'Modified Ashworth Scale score (from 0 to 5)', 'Blood pressure', 'Height (in inches)', 'Heart rate (in beats per minute)', '# of verbal outbursts during a single class', 'Score on Timed Up and Go test (in seconds)']);
...
var $author$project$FunctionOfX$OrderQuadratic = {$: 'OrderQuadratic'};
var $author$project$ScatterPlot$ScatterPlot = F4(
	function (predictorVariable, responseVariable, fOfX, data) {
		return {data: data, fOfX: fOfX, predictorVariable: predictorVariable, responseVariable: responseVariable};
	});
var $author$project$FunctionOfX$OrderConstant = {$: 'OrderConstant'};
var $author$project$FunctionOfX$OrderLinear = {$: 'OrderLinear'};
var $author$project$FunctionOfX$equationOrder = function (fOfX) {
	_v0$2:
	while (true) {
		if (fOfX.b) {
			if (!fOfX.b.b) {
				var x = fOfX.a;
				return $author$project$FunctionOfX$OrderConstant;
			} else {
				if (!fOfX.b.b.b) {
					var x1 = fOfX.a;
					var _v1 = fOfX.b;
					var x2 = _v1.a;
					return $author$project$FunctionOfX$OrderLinear;
				} else {
					break _v0$2;
				}
			}
	...
	return $author$project$FunctionOfX$OrderQuadratic;
};
var $author$project$ScatterPlot$ScatterPlotPoint = F2(
	function (predictor, response) {
		return {predictor: predictor, response: response};
	});
var $author$project$FunctionOfX$calculate = F2(
	function (fOfX, x) {
		var exp = F2(
			function (a, p) {
				return (p <= 0) ? 1 : (a * A2(exp, a, p - 1));
			});
		var fOfXHelper = F2(
			function (coefficients, power) {
				if (coefficients.b) {
					var c = coefficients.a;
					var cs = coefficients.b;
					return (c * A2(exp, x, power)) + A2(fOfXHelper, cs, power + 1);
				} else {
					return 0;
				}
			});
		return A2(fOfXHelper, fOfX, 0);
	});
...
var $jxxcarlson$elm_stat$StatRandom$standardNormal = A3(
...
var $jxxcarlson$elm_stat$StatRandom$normal = F2(
	function (mean_, stdDev) {
		return A2(
			$elm$random$Random$map,
			function (u) {
				return (u * stdDev) + mean_;
			},
			$jxxcarlson$elm_stat$StatRandom$standardNormal);
	});
...
var $author$project$ScatterPlot$pointsGenerator = F3(
	function (xs, fOfX, stdDev) {
		var pointGenerator = function (x) {
			return A2(
				$elm$random$Random$map,
				$author$project$ScatterPlot$ScatterPlotPoint(x),
				A2(
					$jxxcarlson$elm_stat$StatRandom$normal,
					A2($author$project$FunctionOfX$calculate, fOfX, x),
					stdDev));
		};
		var listOfPointGenerators = A2($elm$core$List$map, pointGenerator, xs);
		return $elm_community$random_extra$Random$Extra$sequence(listOfPointGenerators);
	});
var $author$project$ScatterPlot$scatterPlotGeneratorPart3 = F4(
	function (predictorV, responseV, fOfX, stdDev) {
		var xs = A2(
			$elm$core$List$map,
			function (xAsInt) {
				return xAsInt;
		...
		var adjustedStdDev = _Utils_eq(
			$author$project$FunctionOfX$equationOrder(fOfX),
			$author$project$FunctionOfX$OrderQuadratic) ? (stdDev * 10) : stdDev;
		return A2(
			$elm$random$Random$map,
			A3($author$project$ScatterPlot$ScatterPlot, predictorV, responseV, fOfX),
			A3($author$project$ScatterPlot$pointsGenerator, xs, fOfX, adjustedStdDev));
	});
var $author$project$ScatterPlot$scatterPlotGeneratorPart2 = F3(
	function (predictorV, responseV, eqnOrder) {
		var randomlyChooseStdDev = A2($elm$random$Random$float, 20, 40);
		var randomlyChooseFunctionOfX = A2(
			$elm$random$Random$list,
			eqnOrder,
			A2($elm$random$Random$float, 2, 10));
		return A3(
			$elm_community$random_extra$Random$Extra$andThen2,
			A2($author$project$ScatterPlot$scatterPlotGeneratorPart3, predictorV, responseV),
			randomlyChooseFunctionOfX,
			randomlyChooseStdDev);
	});
var $author$project$ScatterPlot$scatterPlotGenerator = function () {
	var randomlyChooseResponseVariable = A2($elm$random$Random$uniform, $author$project$ScatterPlot$firstResponseVariable, $author$project$ScatterPlot$remainingResponseVariables);
	var randomlyChoosePredictorVariable = A2($elm$random$Random$uniform, $author$project$ScatterPlot$firstPredictorVariable, $author$project$ScatterPlot$remainingPredictorVariables);
	var randomlyChooseEqnOrder = A2(
		$elm$random$Random$weighted,
		_Utils_Tuple2(75, 2),
		_List_fromArray(
			[
	...
	return A4($elm_community$random_extra$Random$Extra$andThen3, $author$project$ScatterPlot$scatterPlotGeneratorPart2, randomlyChoosePredictorVariable, randomlyChooseResponseVariable, randomlyChooseEqnOrder);
}();
var $author$project$ScatterPlotQuestion$scatterPlotQuestionGenerator = A3($elm_community$random_extra$Random$Extra$andThen2, $author$project$ScatterPlotQuestion$randomScatterPlotAnswers, $author$project$ScatterPlot$scatterPlotGenerator, $author$project$ScatterPlotQuestion$randomScatterPlotQuestionType);
var $author$project$Main$initModel = function (windowDimensions) {
	return _Utils_Tuple2(
		A2($author$project$Main$createNewModel, windowDimensions, $author$project$MasterySettings$defaultMasterySettings),
		A2($elm$random$Random$generate, $author$project$Main$MsgDisplayNewQuestion, $author$project$ScatterPlotQuestion$scatterPlotQuestionGenerator));
};
...
var $author$project$ProgressBar$addToProgressBar = F3(
	function (progressBarLength, progressBar, progress) {
		return A2(
			$elm$core$List$cons,
			$elm$core$Maybe$Just(progress),
			A2($elm$core$List$take, progressBarLength - 1, progressBar));
	});
...
var $author$project$Main$updateModel = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				switch (msg.a.$) {
					case 'SPQMsgReturnToTorus':
						var _v1 = msg.a;
						return _Utils_Tuple2(
							model,
							$author$project$Main$sendToTorus(true));
					case 'SPQMsgGetNewQuestion':
						var _v2 = msg.a;
						return _Utils_Tuple2(
							model,
							A2($elm$random$Random$generate, $author$project$Main$MsgDisplayNewQuestion, $author$project$ScatterPlotQuestion$scatterPlotQuestionGenerator));
					default:
						var newUserResponse = msg.a.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									progressBar: A3($author$project$ProgressBar$addToProgressBar, model.masterySettings.window, model.progressBar, newUserResponse.correctAnswer),
...
var $author$project$ProgressBar$masteryThresholdReached = F2(
	function (threshold, progressBar) {
		var _v0 = A2(
...
var $author$project$ScatterPlotQuestion$SPQMsgGetNewQuestion = {$: 'SPQMsgGetNewQuestion'};
var $author$project$ScatterPlotQuestion$SPQMsgReturnToTorus = {$: 'SPQMsgReturnToTorus'};
...
var $author$project$ScatterPlotQuestion$viewFeedback = F2(
	function (userResponse, masteryThresholdReached) {
		if (userResponse.$ === 'Nothing') {
			return $mdgriffith$elm_ui$Element$none;
		} else {
			var actualResponse = userResponse.a;
			var _v1 = masteryThresholdReached ? _Utils_Tuple2($author$project$ScatterPlotQuestion$SPQMsgReturnToTorus, 'Return to Lesson') : _Utils_Tuple2($author$project$ScatterPlotQuestion$SPQMsgGetNewQuestion, 'Next Question');
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text(actualResponse.feedback)
									]))
							])),
						A2(
						$mdgriffith$elm_ui$Element$row,
...
var $author$project$MasterySettings$viewInstructionsPanel = function (masterySettings) {
	var instructions = 'You need to answer ' + ($elm$core$String$fromInt(masterySettings.threshold) + (' out of your last ' + ($elm$core$String$fromInt(masterySettings.window) + ' questions correctly in order to advance.')));
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$ProgressBar$viewProgressBar = function (progressBar) {
...
var $author$project$ScatterPlotQuestion$SPQMsgUserResponded = function (a) {
	return {$: 'SPQMsgUserResponded', a: a};
};
...
var $author$project$ScatterPlot$generateAltText = function (sPlot) {
	return 'A scatter plot with ' + (sPlot.predictorVariable + (' on the x axis and ' + (sPlot.responseVariable + ' on the y axis')));
};
...
var $author$project$ScatterPlot$drawScatterPlot = function (sPlot) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Region$description(
				$author$project$ScatterPlot$generateAltText(sPlot)),
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill)
			]),
			...
			A2(
				...
				_List_fromArray(
					[
						...
						{bottom: 30, left: 30, right: 10, top: 25}),
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$alt('This is the alternate text')
							]))
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$text(sPlot.responseVariable)
							])),
						A4(
						$terezka$elm_charts$Chart$labelAt,
						$terezka$elm_charts$Chart$Attributes$middle,
						...
						_List_fromArray(
							[
								$elm$svg$Svg$text(sPlot.predictorVariable)
							]))
					]))));
};
...
var $author$project$ScatterPlotQuestion$viewScatterPlotQuestion = F2(
	function (currentQuestion, userResponse) {
		var drawButton = function (btn) {
			var btnResponse = _Utils_eq(userResponse, $elm$core$Maybe$Nothing) ? $elm$core$Maybe$Just(
				$author$project$ScatterPlotQuestion$SPQMsgUserResponded(btn)) : $elm$core$Maybe$Nothing;
			var btnBackgroundColor = _Utils_eq(userResponse, $elm$core$Maybe$Nothing) ? A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255) : (btn.correctAnswer ? A3($mdgriffith$elm_ui$Element$rgb, 0, 200, 0) : A3($mdgriffith$elm_ui$Element$rgb255, 200, 0, 0));
			return A2(
				$mdgriffith$elm_ui$Element$Input$button,
				_List_fromArray(
					[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text(currentQuestion.stem)
								])),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
							...
							$author$project$ScatterPlot$drawScatterPlot(currentQuestion.scatterPlot))
						])),
					A2(
					...
					A2($elm$core$List$map, drawButton, currentQuestion.possibleResponses))
				]));
	});
var $author$project$Main$viewModel = function (model) {
	var masteryThresholdReached = A2($author$project$ProgressBar$masteryThresholdReached, model.masterySettings.threshold, model.progressBar);
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$MasterySettings$viewInstructionsPanel(model.masterySettings),
					$author$project$ProgressBar$viewProgressBar(model.progressBar),
					A2(
					$mdgriffith$elm_ui$Element$map,
					$author$project$Main$MsgUserResponded,
					A2($author$project$ScatterPlotQuestion$viewScatterPlotQuestion, model.currentQuestion, model.userResponse)),
					A2(
					$mdgriffith$elm_ui$Element$map,
					$author$project$Main$MsgUserResponded,
					A2($author$project$ScatterPlotQuestion$viewFeedback, model.userResponse, masteryThresholdReached))
				])));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$initModel, subscriptions: $author$project$Main$mySubscriptions, update: $author$project$Main$updateModel, view: $author$project$Main$viewModel});
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'winWidth', $elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"FunctionOfX.FunctionOfX":{"args":[],"type":"List.List Basics.Float"},"MasterySettings.MasterySettings":{"args":[],"type":"{ threshold : Basics.Int, window : Basics.Int }"},"QuestionResponse.QuestionResponse":{"args":[],"type":"{ correctAnswer : Basics.Bool, feedback : String.String, textPart : String.String }"},"ScatterPlot.ScatterPlot":{"args":[],"type":"{ predictorVariable : String.String, responseVariable : String.String, fOfX : FunctionOfX.FunctionOfX, data : List.List ScatterPlot.ScatterPlotPoint }"},"ScatterPlot.ScatterPlotPoint":{"args":[],"type":"{ predictor : Basics.Float, response : Basics.Float }"},"ScatterPlotQuestion.ScatterPlotQuestion":{"args":[],"type":"{ stem : String.String, scatterPlot : ScatterPlot.ScatterPlot, possibleResponses : List.List QuestionResponse.QuestionResponse }"}},"unions":{"Main.Msg":{"args":[],"tags":{"MsgReturnToTorus":[],"MsgUpdateMasterySettings":["MasterySettings.MasterySettings"],"MsgWindowSizeChanged":["Basics.Int","Basics.Int"],"MsgGetNewQuestion":[],"MsgDisplayNewQuestion":["ScatterPlotQuestion.ScatterPlotQuestion"],"MsgUserResponded":["ScatterPlotQuestion.ScatterPlotQuestionMsg"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"ScatterPlotQuestion.ScatterPlotQuestionMsg":{"args":[],"tags":{"SPQMsgUserResponded":["QuestionResponse.QuestionResponse"],"SPQMsgReturnToTorus":[],"SPQMsgGetNewQuestion":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));